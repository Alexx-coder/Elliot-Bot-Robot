...
class ElliotBotRobot:
    def __init__(self, name="Elliot Bot Robot", version="3.5.robot"):
        self.name = name
    ...
    def login(self):
        ...
        for попытка in range(3):
          ...
          if result and result[0] is not None:
           ...
           print("ℹУ вас не указана почта. Вход выполнен без проверки.")
        ...
        try:
            ...
            if self.is_admin:
                ...
                if confirm == "нет":
                    ...
                    if code_admin != self.admin_code:
                        print("Код Администратора не совпадает!")
                        return
                    ...
                    if confirm == "нет":
                       ...
                       return
                        ...
                        print("------ Система ------")
                        print("С вас успешно сняты права Администратора! Ваш статус: Обвчный пользователь")
            ...
            if choice == "6":
                ...
                while True:
                    ...
                    if choice_3 == "2":
                        ...
                        print("Язык программирования: Python 3.13 | Лицензия: MIT LICENSE")
